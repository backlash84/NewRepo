    ...
    def apply_theme_colors(self, bg_color, accent_color, text_color, entry_bg_color="#222222"):
        def apply_recursive(widget):
            try:
                ...
                elif isinstance(widget, ctk.CTkOptionMenu):  # handles dropdown menus like character_dropdown
                    widget.configure(
...
class ChatView(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        self.chat_display = ctk.CTkTextbox(inner, height=350, width=600, wrap="word",
                                           fg_color=entry_bg_color, text_color=text_color,
                                           border_color=accent_color, border_width=2)
        self.chat_display.pack(pady=10)
        self.chat_display.configure(state="disabled")

        self.entry = ctk.CTkTextbox(inner, width=500, height=60, wrap="word",
                                    fg_color=entry_bg_color, text_color=text_color,
                                    border_color=accent_color, border_width=2)
...
class CharacterSettings(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.scenario_box = ctk.CTkTextbox(inner, height=100, width=500)
        ...
        self.prefix_box = ctk.CTkTextbox(inner, height=180, width=500)
